...
<html lang="zh-CN">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <li class="active"><a href="./mybook">MY BOOKS</a></li>
            </ul>
  ...
  <table class="table table-striped">
        ...
        <%
            List<Mybook> booklist = (List<Mybook>) session.getAttribute("mybooks");
            for (Mybook bk : booklist) {
        %>
        <tr>
